/*
This is the arduino code to use in the Macro keyboard! it uses my own code for the buttons,
as well as code adapted from Mikolas Zuza's Media Control Volume Knob on https://blog.prusaprinters.org/3d-print-an-oversized-media-control-volume-knob-arduino-basics_30184/
